...
public class BrokerImpl3 extends Thread implements Broker, Serializable {
    private int id;
    private int port;
    ...
    public BrokerImpl3(int id, String ip, int port) {
        this.id = id;
        this.ip = ip;
        this.port = port;
        requestSocket = null;
    ...
    public static void main(String[] args) throws InvalidDataException, IOException, UnsupportedTagException {
        ...
        BrokerImpl3 b =(BrokerImpl3) brokers.get(id);
        b.init(id);
        b.start();
    }
